...
/obj/item/stack/medical/splint/attack(mob/living/carbon/M as mob, mob/user as mob)
	...
	if (istype(M, /mob/living/carbon/pony))
		...
		if(!(affecting.name == "r_foreleg" || affecting.name == "r_foreleg" || affecting.name == "l_backleg" || affecting.name == "r_backleg"))
		...
		if(M != user)
			...
			if((!user.hand && affecting.name == "r_foreleg") || (user.hand && affecting.name == "r_foreleg"))
