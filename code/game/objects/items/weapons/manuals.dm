...
/obj/item/weapon/book/manual/robotics_cyborgs
	...
	dat = {"<html>
				...
				The service cyborg module comes ready to serve your pony needs. It includes various entertainment and refreshment devices. Occasionally some service cyborgs may have been referred to as "Bros."<br>A Service Cyborg comes with:
				<ul>
				  <li>Shaker</li>
				...
				<ol>
				  ...
				  <li>While the parts are being constructed, take your pony brain, and place it inside the Man-Machine Interface</li>
...
/obj/item/weapon/book/manual/medical_diagnostics_manual/New()
	...
	dat = {"<html>
				...
				<ol>
					<li>Now, as a new doctor, I solemnly promise that I will, to the best of my ability, serve ponyity-caring for the sick, promoting good health, and alleviating pain and suffering.</li>
					...
					<li>I will oppose policies in breach of pony rights and will not participate in them. I will strive to change laws that are contrary to my profession's ethics and will work towards a fairer distribution of health resources.</li>
...
/obj/item/weapon/book/manual/evaguide
	...
	dat = {"<html>
				...
				These suits generally only fit one species. Nanotrasen's are usually pony-fitting by default, but there's equipment that can make modifications to the hardsuits to fit them to other species.<BR><BR>
