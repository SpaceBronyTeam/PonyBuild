...
/obj/item/toy/balloon/attack(mob/living/carbon/pony/M as mob, mob/user as mob)
	return
...
/obj/item/toy/snappop/Crossed(H as mob|obj)
	if((ispony(H))) //i guess carp and shit shouldn't set them off
...
/obj/item/toy/waterflower/attack(mob/living/carbon/pony/M as mob, mob/user as mob)
	return
