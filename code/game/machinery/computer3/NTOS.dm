...
/datum/file/program/ntos/interact()
	...
	<body><div style='width:640px;height:480px;	border:2px solid black;padding:8px;background-position:center; background-attachment: fixed; background-image:url(\ref['nano/images/uiBackground.png'])'>"}
