...
/obj/machinery/suit_storage_unit
	...
	icon_state = "suitstorage000000100" //order is: [has helmet][has suit][has pony][is open][is locked][is UV cycling][is powered][is dirty/broken] [is superUVcycling]
	anchored = 1
	density = 1
	var/mob/living/carbon/pony/OCCUPANT = null
...
/obj/machinery/suit_storage_unit/update_icon()
	...
	if(OCCUPANT)
		haspony = 1
	icon_state = text("suitstorage[][][][][][][][][]",hashelmet,hassuit,haspony,src.isopen,src.islocked,src.isUV,src.ispowered,src.isbroken,src.issuperUV)
