...
/mob/living/silicon/ai/proc/trackable_mobs()
	...
	var/list/targets = sortList(TB.ponys) + sortList(TB.others)
	src.track = TB
	return targets
...
/mob/living/silicon/ai/proc/ai_camera_track(var/target_name in trackable_mobs())
	...
	var/mob/target = (isnull(track.ponys[target_name]) ? track.others[target_name] : track.ponys[target_name])
	src.track = null
...
/mob/living/carbon/pony/tracking_status()
