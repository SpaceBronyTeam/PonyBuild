...
/obj/machinery/alarm/proc/first_run()
	...
	// breathable air according to pony/Life()
...
/obj/machinery/firealarm/attack_hand(mob/user as mob)
	...
	var/d1
	var/d2
	if (istype(user, /mob/living/carbon/pony) || istype(user, /mob/living/silicon))
		A = A.loc
		A = A.master
...
/obj/machinery/partyalarm/attack_hand(mob/user as mob)
	...
	var/d1
	var/d2
	if (istype(user, /mob/living/carbon/pony) || istype(user, /mob/living/silicon/ai))
