/obj/machinery/transformer
	...
	desc = "A large metalic machine with an entrance and an exit. A sign on the side reads, 'pony go in, robot come out', pony must be lying down and alive."
...
/obj/machinery/transformer/Bumped(var/atom/movable/AM)
	...
	if(ispony(AM))
		// Only ponys can enter from the west side, while lying down.
...
/obj/machinery/transformer/proc/transform(var/mob/living/carbon/pony/H)
