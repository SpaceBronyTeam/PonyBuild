...
// called from mob/living/carbon/pony/Crossed()
// when mulebot is in the same loc
/obj/machinery/bot/mulebot/proc/RunOver(var/mob/living/carbon/pony/H)
	...
	H.apply_damage(0.5*damage, BRUTE, "l_backleg")
	H.apply_damage(0.5*damage, BRUTE, "r_backleg")
	H.apply_damage(0.5*damage, BRUTE, "r_foreleg")
	H.apply_damage(0.5*damage, BRUTE, "r_foreleg")
