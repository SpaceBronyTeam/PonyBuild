...
//Start growing a pony clone in the pod!
/obj/machinery/clonepod/proc/growclone(var/datum/dna2/record/R)
	...
	var/mob/living/carbon/pony/H = new /mob/living/carbon/pony(src, R.dna.species)
	occupant = H
...
/obj/item/weapon/paper/Cloning
	...
	Using the H-87 is almost as simple as brain surgery! Simply insert the target ponyoid into the scanning chamber and select the scan option to create a new profile!<br>
