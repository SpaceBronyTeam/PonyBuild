 ...
 **/
	...
	proc/EquipRank(var/mob/living/carbon/pony/H, var/rank, var/joined_late = 0)
		...
		if(istype(H)) //give ponys wheelchairs, if they need them.
			var/datum/organ/external/l_backhoof = H.get_organ("l_backhoof")
			var/datum/organ/external/r_backhoof = H.get_organ("r_backhoof")
...
//		H.update_icons()
	...
	proc/spawnId(var/mob/living/carbon/pony/H, rank, title)
		if(!H)	return 0
