...
/obj/item/weapon/book/tome
	...
	tomedat = {"<html>
				...
				<h3>Raise Dead</h3>
				This rune allows for the resurrection of any dead person. You will need a dead pony body and a living pony sacrifice. Make 2 raise dead runes. Put a living, awake pony on top of one, and a dead body on the other one. When you invoke the rune, the life force of the living pony will be transferred into the dead body, allowing a ghost standing on top of the dead body to enter it, instantly and fully healing it. Use other runes to ensure there is a ghost ready to be resurrected.<br>
				<h3>Hide runes</h3>
				...
				<h3>Sacrifice</h3>
				Sacrifice rune allows you to sacrifice a living thing or a body to the Geometer of Blood. Monkeys and dead ponys are the most basic sacrifices, they might or might not be enough to gain His favor. A living pony is what a real sacrifice should be, however, you will need 3 people chanting the invocation to sacrifice a living person.
				<h3>Create a wall</h3>
