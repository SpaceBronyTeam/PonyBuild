...
/datum/game_mode/proc/prepare_syndicate_leader(var/datum/mind/synd_mind, var/nuke_code)
	...
	if (nuke_code)
		...
		if (ticker.mode.config_tag=="mercenary")
			...
			var/mob/living/carbon/pony/H = synd_mind.current
			P.loc = H.loc
...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/pony/synd_mob)
...
/datum/game_mode/proc/is_operatives_are_dead()
	for(var/datum/mind/operative_mind in syndicates)
		if (!istype(operative_mind.current,/mob/living/carbon/pony))
