...
//////////////////////////////Capturing////////////////////////////////////////////////////////
	...
	attack(mob/living/carbon/pony/M as mob, mob/user as mob)
		if(!istype(M, /mob/living/carbon/pony))//If target is not a pony.
			return ..()
		if(istype(M, /mob/living/carbon/pony/dummy))
			return..()
...
/obj/item/proc/transfer_soul(var/choice as text, var/target, var/mob/U as mob)
	switch(choice)
		if("VICTIM")
			var/mob/living/carbon/pony/T = target
				...
				if (T.stat == 0)
					...
					if(T.client == null)
						...
						if(C.contents.len)
							...
							new /obj/effect/decal/remains/pony(T.loc) //Spawns a skeleton
							T.invisibility = 101
