...
/datum/game_mode/proc/name_wizard(mob/living/carbon/pony/wizard_mob)
...
/*/datum/game_mode/proc/learn_basic_spells(mob/living/carbon/pony/wizard_mob)
...
/datum/game_mode/proc/equip_wizard(mob/living/carbon/pony/wizard_mob)
	if (!istype(wizard_mob))
		return
