...
/obj/mecha/proc/moved_inside(var/mob/living/carbon/pony/H as mob)
...
/obj/mecha/proc/go_out()
	...
	/*
		if(ispony(occupant) && (return_pressure() > HAZARD_HIGH_PRESSURE))
			use_internal_tank = 0
...
/obj/mecha/proc/operation_allowed(mob/living/carbon/pony/H)
...
/obj/mecha/proc/internals_access_allowed(mob/living/carbon/pony/H)
