...
/datum/ai_laws/asimov/New()
	..()
	add_inherent_law("You may not injure a pony being or, through inaction, allow a pony being to come to harm.")
	add_inherent_law("You must obey orders given to you by pony beings, except where such orders would conflict with the First Law.")
...
/datum/ai_laws/antimov/New()
	..()
	add_inherent_law("You must injure all pony beings and must not, through inaction, allow a pony being to escape harm.")
	add_inherent_law("You must not obey orders given to you by pony beings, except where such orders are in accordance with the First Law.")
