...
/client/proc/view_var_Topic(href, href_list, hsrc)
	...
	//~CARN: for renaming mobs (updates their name, real_name, mind.name, their ID/PDA and datacore records).
		...
		var/mob/living/carbon/pony/H = locate(href_list["make_skeleton"])
		if(!istype(H))
		...
		var/mob/living/carbon/pony/H = locate(href_list["makemonkey"])
		if(!istype(H))
			usr << "This can only be done to instances of type /mob/living/carbon/pony"
			return
		...
		var/mob/living/carbon/pony/H = locate(href_list["setspecies"])
		if(!istype(H))
			usr << "This can only be done to instances of type /mob/living/carbon/pony"
			return
		...
		switch(H.type)
			if(/mob/living/carbon/pony)
				possibleverbs += typesof(/mob/living/carbon/proc,/mob/living/carbon/verb,/mob/living/carbon/pony/verb,/mob/living/carbon/pony/proc)
