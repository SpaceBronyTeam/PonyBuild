...
/*
/client/var/watch_mod = 0
/client/MouseMove()
	..()
	var/obj/screen/watch_eye/eye = locate(/obj/screen/watch_eye) in screen
	if(!eye)
		eye = new
		screen += eye
	if(watch_mod)
...
/obj/screen/watch
	...
	icon_state = "sleep1"
	Click()
		if(icon_state=="sleep1")
			icon_state = "sleep0"
			usr.watch_mod = 1
		else
			icon_state = "sleep1"
			usr.client.watch_mod = 0
*/
