...
*/
/mob/living/carbon/pony/UnarmedAttack(var/atom/A, var/proximity)
...
/mob/living/carbon/pony/RangedAttack(var/atom/A)
...
/mob/living/carbon/monkey/RestrainedClickOn(var/atom/A)
	...
	var/dam_zone = ran_zone(pick("chest", "l_forehoof", "r_forehoof", "l_backleg", "r_backleg"))
