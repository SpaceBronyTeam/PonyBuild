...
var/global/list/whitelisted_species = list("Earthpony", "Unicorn", "Pegasus", "Griffon") // Species that require a whitelist check.
var/global/list/playable_species = list("Earthpony", "Unicorn", "Pegasus", "Griffon", "Alicorn")    // A list of ALL playable species, whitelisted, latejoin or otherwise.
