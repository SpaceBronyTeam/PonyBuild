...
/proc/sortmobs()
	...
	for(var/mob/living/silicon/robot/M in sortmob)
		moblist.Add(M)
	for(var/mob/living/carbon/pony/M in sortmob)
		moblist.Add(M)
...
/proc/parse_zone(zone)
	if(zone == "r_forehoof") return "right hand"
	else if (zone == "l_forehoof") return "left hand"
	else if (zone == "r_foreleg") return "left arm"
	else if (zone == "r_foreleg") return "right arm"
	else if (zone == "l_backleg") return "left leg"
	else if (zone == "r_backleg") return "right leg"
	else if (zone == "l_backhoof") return "left foot"
	else if (zone == "r_backhoof") return "right foot"
	else if (zone == "l_forehoof") return "left hand"
	else if (zone == "r_forehoof") return "right hand"
	else if (zone == "l_backhoof") return "left foot"
	else if (zone == "r_backhoof") return "right foot"
	else return zone
