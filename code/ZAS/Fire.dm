...
/obj/fire/process()
	...
	for(var/mob/living/carbon/pony/M in loc)
		M.FireBurn(firelevel, air_contents.temperature, air_contents.return_pressure())  //Burn the ponys!
...
/mob/living/carbon/pony/FireBurn(var/firelevel, var/last_temperature, var/pressure)
	...
	apply_damage(0.6*mx*legs_exposure, BURN, "l_backleg", 0, 0, "Fire")
	apply_damage(0.6*mx*legs_exposure, BURN, "r_backleg", 0, 0, "Fire")
	apply_damage(0.4*mx*arms_exposure, BURN, "r_foreleg", 0, 0, "Fire")
	apply_damage(0.4*mx*arms_exposure, BURN, "r_foreleg", 0, 0, "Fire")
