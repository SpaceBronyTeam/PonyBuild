/mob/living/carbon/monkey
	...
	var/greaterform = "Earthpony"                  // Used when ponyizing a monkey.
	icon_state = "monkey1"
	//var/uni_append = "12C4E2"                // Small appearance modifier for different species.
	var/list/uni_append = list(0x12C,0x4E2)    // Same as above for DNA2.
	var/update_muts = 1                        // Monkey gene must be set at start.

/mob/living/carbon/monkey/pegasus
	name = "farwa"
	voice_name = "farwa"
...
/mob/living/carbon/monkey/griffon
	name = "stok"
	voice_name = "stok"
	speak_emote = list("hisses")
	icon_state = "stokkey1"
...
/mob/living/carbon/monkey/attack_hand(mob/living/carbon/pony/M as mob)
