...
/mob/living/carbon/pony/New(var/new_loc, var/new_species = null)
...
/mob/living/carbon/pony/ex_act(severity)
	if(!blinded)
		flick("flash", flash)
...
/mob/living/carbon/pony/blob_act()
	if(stat == 2)	return
	show_message("\red The blob attacks you!")
	var/dam_zone = pick("chest", "l_forehoof", "r_forehoof", "l_backleg", "r_backleg")
	var/datum/organ/external/affecting = get_organ(ran_zone(dam_zone))
	apply_damage(rand(30,40), BRUTE, affecting, run_armor_check(affecting, "melee"))
	return

/mob/living/carbon/pony/meteorhit(O as obj)
...
/mob/living/carbon/pony/proc/implant_loyalty(mob/living/carbon/pony/M, override = FALSE) // Won't override by default.
...
/mob/living/carbon/pony/proc/is_loyalty_implanted(mob/living/carbon/pony/M)
...
/mob/living/carbon/pony/restrained()
	if (handcuffed)
		return 1
...
/mob/living/carbon/pony/var/co2overloadtime = null
/mob/living/carbon/pony/var/temperature_resistance = T0C+75


/mob/living/carbon/pony/show_inv(mob/user as mob)
	...
	dat += {"<BR><B>Gloves:</B> <A href='?src=\ref[src];item=gloves'>[(gloves ? gloves : "Nothing")]</A>
...
// called when something steps onto a pony
// this handles mulebots and vehicles
/mob/living/carbon/pony/Crossed(var/atom/movable/AM)
...
/mob/living/carbon/pony/proc/get_authentification_rank(var/if_no_id = "No id", var/if_no_job = "No job")
...
/mob/living/carbon/pony/proc/get_assignment(var/if_no_id = "No id", var/if_no_job = "No job")
	var/obj/item/device/pda/pda = wear_id
	if (istype(pda))
		if (pda.id)
...
//Useful when player do something with computers
/mob/living/carbon/pony/proc/get_authentification_name(var/if_no_id = "Unknown")
	var/obj/item/device/pda/pda = wear_id
	if (istype(pda))
		if (pda.id)
...
/mob/living/carbon/pony/proc/get_visible_name()
...
//Returns "Unknown" if facially disfigured and real_name if not. Useful for setting name when polyacided or when updating a pony's name variable
/mob/living/carbon/pony/proc/get_face_name()
...
/mob/living/carbon/pony/proc/get_id_name(var/if_no_id = "Unknown")
	. = if_no_id
...
/mob/living/carbon/pony/proc/get_idcard()
	if(wear_id)
		return wear_id.GetID()

//Removed the horrible safety parameter. It was only being used by ninja code anyways.
//Now checks siemens_coefficient of the affected area by default
/mob/living/carbon/pony/electrocute_act(var/shock_damage, var/obj/source, var/base_siemens_coeff = 1.0, var/def_zone = null)
	if(status_flags & GODMODE)	return 0	//godmode

	if (!def_zone)
		def_zone = pick("l_forehoof", "r_forehoof")
...
/mob/living/carbon/pony/Topic(href, href_list)
	...
	if ((href_list["item"] && !( usr.stat ) && usr.canmove && !( usr.restrained() ) && in_range(src, usr) && ticker)) //if game hasn't started, can't make an equip_e
		var/obj/effect/equip_e/pony/O = new /obj/effect/equip_e/pony(  )
		O.source = usr
		O.target = src
									...
									if(setcriminal != "Cancel")
										...
										spawn()
											...
											if(istype(usr,/mob/living/carbon/pony))
												var/mob/living/carbon/pony/U = usr
...
/mob/living/carbon/pony/eyecheck()
	var/number = 0
...
/mob/living/carbon/pony/IsAdvancedToolUser(var/silent)
...
/mob/living/carbon/pony/abiotic(var/full_body = 0)
...
/mob/living/carbon/pony/proc/check_dna()
	dna.check_integrity(src)
	return

/mob/living/carbon/pony/get_species()
	if(!species)
		set_species()
	return species.name

/mob/living/carbon/pony/proc/play_xylophone()
	if(!src.xylophone)
...
/mob/living/carbon/pony/proc/vomit()
...
/mob/living/carbon/pony/proc/morph()
	set name = "Morph"
	...
	if(!(mMorph in mutations))
		src.verbs -= /mob/living/carbon/pony/proc/morph
		return
...
/mob/living/carbon/pony/proc/remotesay()
	...
	if(!(mRemotetalk in src.mutations))
		src.verbs -= /mob/living/carbon/pony/proc/remotesay
		return
...
/mob/living/carbon/pony/proc/remoteobserve()
	...
	if(!(mRemote in src.mutations))
		remoteview_target = null
		reset_view(0)
		src.verbs -= /mob/living/carbon/pony/proc/remoteobserve
		return
...
/mob/living/carbon/pony/proc/get_visible_gender()
	if(wear_suit && wear_suit.flags_inv & HIDEJUMPSUIT && ((head && head.flags_inv & HIDEMASK) || wear_mask))
		return NEUTER
	return gender

/mob/living/carbon/pony/proc/increase_germ_level(n)
	if(gloves)
		gloves.germ_level += n
	else
		germ_level += n

/mob/living/carbon/pony/revive()
...
/mob/living/carbon/pony/proc/is_lung_ruptured()
	var/datum/organ/internal/lungs/L = internal_organs_by_name["lungs"]
	return L && L.is_bruised()

/mob/living/carbon/pony/proc/rupture_lung()
	var/datum/organ/internal/lungs/L = internal_organs_by_name["lungs"]
...
/*
/mob/living/carbon/pony/verb/simulate()
	set name = "sim"
	set background = 1
...
/mob/living/carbon/pony/add_blood(mob/living/carbon/pony/M as mob)
	if (!..())
		return 0
	...
	verbs += /mob/living/carbon/pony/proc/bloody_doodle
	return 1 //we applied blood to the item

/mob/living/carbon/pony/clean_blood(var/clean_feet)
	.=..()
...
/mob/living/carbon/pony/get_visible_implants(var/class = 0)
...
/mob/living/carbon/pony/proc/handle_embedded_objects()
...
/mob/living/carbon/pony/verb/check_pulse()
	set category = "Object"
...
/mob/living/carbon/pony/proc/set_species(var/new_species, var/default_colour)

	if(!dna)
		if(!new_species)
			new_species = "Earthpony"
	else
		if(!new_species)
...
/mob/living/carbon/pony/proc/bloody_doodle()
	set category = "IC"
...
/mob/living/carbon/pony/can_inject(var/mob/user, var/error_msg, var/target_zone)
	. = 1
	...
	if(!target_zone)
		if(!user)
			...
			target_zone = user.zone_sel.selecting.name
...
/mob/living/carbon/pony/print_flavor_text(var/shrink = 1)
...
/mob/living/carbon/pony/getDNA()
	if(species.flags & NO_SCAN)
		return null
	..()

/mob/living/carbon/pony/setDNA()
	if(species.flags & NO_SCAN)
		return
	..()

/mob/living/carbon/pony/has_brain()
...
/mob/living/carbon/pony/has_eyes()
...
/mob/living/carbon/pony/slip(var/slipped_on, stun_duration=8)
	if((species.flags & NO_SLIP) || (shoes && (shoes.flags & NOSLIP)))
		return 0
	..(slipped_on,stun_duration)

/mob/living/carbon/pony/reset_view(atom/A, update_hud = 1)
	..()
	if(update_hud)
