...
/mob/living/simple_animal/cat/proc/handle_movement_target()
	//if our target is neither inside a turf or inside a pony(???), stop
	if((movement_target) && !(isturf(movement_target.loc) || ispony(movement_target.loc) ))
		movement_target = null
		stop_automated_movement = 0
...
/mob/living/simple_animal/cat/attack_hand(mob/living/carbon/pony/M as mob)
	. = ..()
	if(M.a_intent == "hurt")
		set_flee_target(M)
...
/mob/living/simple_animal/cat/fluff
	var/mob/living/carbon/pony/friend
...
/mob/living/simple_animal/cat/fluff/verb/friend()
	...
	if (!(ispony(usr) && befriend_job && usr.job == befriend_job))
