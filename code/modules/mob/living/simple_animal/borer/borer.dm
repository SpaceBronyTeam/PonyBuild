...
/mob/living/simple_animal/borer
	...
	var/mob/living/carbon/pony/host        // pony host for the brain worm.
	var/truename                            // Name used for brainworm-speak.
	var/mob/living/captive_brain/host_brain // Used for swapping control of the body back and forth.
	var/controlling                         // Used in pony death check.
...
/mob/living/simple_animal/borer/proc/detatch()
	...
	if(istype(host,/mob/living/carbon/pony))
		var/mob/living/carbon/pony/H = host
...
/mob/living/simple_animal/borer/proc/request_player()
	for(var/mob/dead/observer/O in player_list)
		if(jobban_isbanned(O, "Borer"))
			continue
		if(O.client)
			if(O.client.prefs.be_special & BE_CHANGELING_INFILTRATOR)
				question(O.client)
...
/mob/living/simple_animal/borer/proc/question(var/client/C)
	spawn(0)
		...
		if(response == "Yes")
			...
			C.prefs.be_special ^= BE_CHANGELING_INFILTRATOR
