...
/mob/living/simple_animal/parrot
	...
	var/parrot_dam_zone = list("chest", "head", "r_foreleg", "l_backleg", "r_foreleg", "r_backleg") //For ponys, select a bodypart to attack
...
/mob/living/simple_animal/parrot/Topic(href, href_list)
	...
	if(ispony(usr) || ismonkey(usr) || isrobot(usr))
...
//-----ATTACKING
		...
		if(in_range(src, parrot_interest))
			...
			if(ispony(parrot_interest))
				var/mob/living/carbon/pony/H = parrot_interest
