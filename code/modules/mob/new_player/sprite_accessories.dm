...
/datum/sprite_accessory/pony_tail
	...
	griffon
		name = "Griffon Tail"
		icon = 'icons/mob/tail64.dmi'
		icon_state = "griffon_tail"
		species_allowed = list("Griffon")
		has_base = 1

	changeling_princess
		name = "Changeling Princess Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_princess.dmi'
		icon_state = "tail"
		species_allowed = list("Changeling Princess")
		do_colouration = 0

	changeling_queen
		name = "Changeling Queen Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_queen.dmi'
		icon_state = "tail"
		species_allowed = list("Changeling Queen")
		do_colouration = 0

	changeling_drone
		name = "Changeling Drone Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_drone.dmi'
		icon_state = "tail"
		species_allowed = list("Changeling Drone")
		do_colouration = 0

	changeling_hatchling
		name = "Changeling Hatchling Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_hatchling.dmi'
		icon_state = "tail"
		species_allowed = list("Changeling Hatchling")
		do_colouration = 0

	changeling_sentinel
		name = "Changeling Sentinel Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_sentinel.dmi'
		icon_state = "tail"
		species_allowed = list("Changeling Sentinel")
		do_colouration = 0

	changeling_male
		name = "Changeling Male Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_infiltrator.dmi'
		icon_state = "tail_m"
		gender = MALE
		species_allowed = list("Changeling Infiltrator")
		do_colouration = 0
	changeling_female
		name = "Changeling Female Tail"
		icon = 'icons/mob/pony_races/xenos/r_changeling_infiltrator.dmi'
		icon_state = "tail_f"
		gender = FEMALE
		species_allowed = list("Changeling Infiltrator")
...
/datum/sprite_accessory/hair
	...
	bald
		...
		icon_state = "bald"
		gender = MALE
		species_allowed = list("Earthpony","Unicorn", "Pegasus", "Alicorn", "Changeling Queen", "Changeling Princess", "Changeling Drone", "Changeling Infiltrator", "Changeling Sentinel", "Changeling Hatchling")
