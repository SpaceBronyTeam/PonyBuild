...
/datum/preferences/proc/load_preferences()
	...
	if(usr)	S["language"]	>> usr.client.language
...
/datum/preferences/proc/save_preferences()
	...
	S["default_slot"]		<< default_slot
	S["toggles"]			<< toggles
	if(usr)	S["language"]	<< usr.client.language //язык пользовател€. Ќе персонажа
...
/datum/preferences/proc/load_character(slot)
	...
	S["skin_green"]			>> g_skin
	S["skin_blue"]			>> b_skin
	S["skin_head_red"]		>> r_skin_head
	S["skin_head_green"]	>> g_skin_head
	S["skin_head_blue"]		>> b_skin_head
	S["skin_claws_red"]		>> r_skin_claws
	S["skin_claws_green"]	>> g_skin_claws
	S["skin_claws_blue"]	>> b_skin_claws
	S["skin_beak_red"]		>> r_skin_beak
	S["skin_beak_green"]	>> g_skin_beak
	S["skin_beak_blue"]		>> b_skin_beak
	S["backcolor_red"]		>> r_backcolor
	S["backcolor_green"]	>> g_backcolor
	S["backcolor_blue"]		>> b_backcolor
	...
	r_skin_head		= sanitize_integer(r_skin_head, 0, 255, initial(r_skin_head))
	g_skin_head		= sanitize_integer(g_skin_head, 0, 255, initial(g_skin_head))
	b_skin_head		= sanitize_integer(b_skin_head, 0, 255, initial(b_skin_head))
	r_skin_claws	= sanitize_integer(r_skin_claws, 0, 255, initial(r_skin_claws))
	g_skin_claws	= sanitize_integer(g_skin_claws, 0, 255, initial(g_skin_claws))
	b_skin_claws	= sanitize_integer(b_skin_claws, 0, 255, initial(b_skin_claws))
	r_skin_beak		= sanitize_integer(r_skin_beak, 0, 255, initial(r_skin_beak))
	g_skin_beak		= sanitize_integer(g_skin_beak, 0, 255, initial(g_skin_beak))
	b_skin_beak		= sanitize_integer(b_skin_beak, 0, 255, initial(b_skin_beak))
	r_backcolor		= sanitize_integer(r_backcolor, 0, 255, initial(r_backcolor))
	g_backcolor		= sanitize_integer(g_backcolor, 0, 255, initial(g_backcolor))
	b_backcolor		= sanitize_integer(b_backcolor, 0, 255, initial(b_backcolor))
