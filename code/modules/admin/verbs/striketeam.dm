...
//Spawns commandos and equips them.
	for(var/obj/effect/landmark/L in landmarks_list)
		...
		if (L.name == "Commando")
			...
			var/mob/living/carbon/pony/new_commando = create_death_commando(L, leader_selected)
...
/client/proc/create_death_commando(obj/spawn_location, leader_selected = 0)
	var/mob/living/carbon/pony/new_commando = new(spawn_location.loc)
...
/mob/living/carbon/pony/proc/equip_death_commando(leader_selected = 0)
