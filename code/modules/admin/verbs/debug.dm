...
/mob/living/carbon/pony/ instead. And that gives a run-time error.
But you can call procs that are of type /mob/living/carbon/pony/proc/ for that player.
*/
...
/client/proc/cmd_admin_monkeyize(var/mob/M in world)
	...
	if(!ticker)
		...
		return
	if(istype(M, /mob/living/carbon/pony))
		var/mob/living/carbon/pony/target = M
...
/client/proc/cmd_debug_del_all()
	...
	var/blocked = list(/obj, /mob, /mob/living, /mob/living/carbon, /mob/living/carbon/pony, /mob/dead, /mob/dead/observer, /mob/living/silicon, /mob/living/silicon/robot, /mob/living/silicon/ai)
...
/client/proc/cmd_admin_dress(var/mob/living/carbon/pony/M in mob_list)
	set category = "Fun"
