	...
	if (M.client)
		if(!istype(M, /mob/new_player))
			...
			body += {"<br><br>
				...
				<A href='?src=\ref[src];simplemake=pony;species=Changeling Hatchling;mob=\ref[M]'>Hatchling</A>
				<A href='?src=\ref[src];simplemake=pony;species=Changeling Drone;mob=\ref[M]'>Drone</A>
				<A href='?src=\ref[src];simplemake=pony;species=Changeling Infiltrator;mob=\ref[M]'>Infiltrator</A>
				<A href='?src=\ref[src];simplemake=pony;species=Changeling Sentinel;mob=\ref[M]'>Sentinel</A>
				<A href='?src=\ref[src];simplemake=pony;species=Changeling Princess;mob=\ref[M]'>Princess</A>
				<A href='?src=\ref[src];simplemake=pony;species=Changeling Queen;mob=\ref[M]'>Queen</A> \] |
				\[ Crew: <A href='?src=\ref[src];simplemake=Earthpony;mob=\ref[M]'>Pony</A>
				...
				<A href='?src=\ref[src];simplemake=pony;species=Griffon;mob=\ref[M]'>Griffon</A>
...
/datum/admins/proc/Secrets()
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<A href='?src=\ref[src];secretsfun=monkey'>Turn all ponys into monkeys</A><BR>
...
/datum/admins/proc/show_skills(var/mob/living/carbon/pony/M as mob in world)
	set category = "Admin"
...
/client/proc/update_mob_sprite(mob/living/carbon/pony/H as mob)
	set category = "Admin"
