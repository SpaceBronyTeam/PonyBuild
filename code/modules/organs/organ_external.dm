...
/datum/organ/external/proc/take_damage(brute, burn, sharp, edge, used_weapon = null, list/forbidden_limbs = list())
	...
	if(status & ORGAN_ROBOT )
		...
		if(istype(owner,/mob/living/carbon/pony))
			var/mob/living/carbon/pony/H = owner
...
/datum/organ/external/proc/fracture()
	...
	// hardsuit rewrite.
	if(!(status & ORGAN_SPLINTED) && istype(owner,/mob/living/carbon/pony))
...
/datum/organ/external/get_icon(var/icon/race_icon, var/icon/deform_icon,gender="")
	if (status & ORGAN_ROBOT && !(owner.species && owner.species.flags & IS_SYNTHETIC))
		return new /icon('icons/mob/pony_races/robotic.dmi', "[icon_name][gender ? "_[gender]" : ""]")
...
/datum/organ/external/r_wing
	name = "r_wing"
	icon_name = ""
	display_name = "right wing"
	max_damage = 30
	min_broken_damage = 15
	body_part = UPPER_TORSO

/datum/organ/external/l_wing
	name = "l_wing"
	icon_name = ""
	display_name = "left wing"
	max_damage = 30
	min_broken_damage = 15
	body_part = UPPER_TORSO
...
/datum/organ/external/l_foreleg
	name = "l_foreleg"
	display_name = "left foreleg"
	icon_name = "l_foreleg"
	max_damage = 50
...
/datum/organ/external/l_backleg
	name = "l_backleg"
	display_name = "left backleg"
	icon_name = "l_backleg"
	max_damage = 50
	min_broken_damage = 20
	body_part = LEG_LEFT
...
/datum/organ/external/r_foreleg
	name = "r_foreleg"
	display_name = "right foreleg"
	icon_name = "r_foreleg"
	max_damage = 50
	min_broken_damage = 20
	body_part = ARM_RIGHT
...
/datum/organ/external/r_backleg
	name = "r_backleg"
	display_name = "right backleg"
	icon_name = "r_backleg"
	max_damage = 50
	min_broken_damage = 20
	body_part = LEG_RIGHT
...
/datum/organ/external/l_backhoof
	name = "l_backhoof"
	display_name = "left backhoof"
	icon_name = "l_backhoof"
	max_damage = 30
	min_broken_damage = 15
	body_part = FOOT_LEFT
	icon_position = LEFT

/datum/organ/external/r_backhoof
	name = "r_backhoof"
	display_name = "right backhoof"
	icon_name = "r_backhoof"
	max_damage = 30
	min_broken_damage = 15
	body_part = FOOT_RIGHT
	icon_position = RIGHT

/datum/organ/external/r_forehoof
	name = "r_forehoof"
	display_name = "right forehoof"
	icon_name = "r_forehoof"
	max_damage = 30
	min_broken_damage = 15
...
/datum/organ/external/l_forehoof
	name = "l_forehoof"
	display_name = "left forehoof"
	icon_name = "l_forehoof"
	max_damage = 30
	min_broken_damage = 15
	body_part = HAND_LEFT
...
obj/item/weapon/organ/New(loc, mob/living/carbon/pony/H)
	..(loc)
	if(!istype(H))
		return
	if(H.dna)
	...
	if(H.species && H.species.icobase)
		...
		base = icon('icons/mob/pony_races/r_pony.dmi')
...
obj/item/weapon/organ/l_arm
	name = "left arm"
	icon_state = "r_foreleg"
obj/item/weapon/organ/l_foot
	name = "left foot"
	icon_state = "l_backhoof"
obj/item/weapon/organ/l_hand
	name = "left hand"
	icon_state = "l_forehoof"
obj/item/weapon/organ/l_leg
	name = "left leg"
	icon_state = "l_backleg"
obj/item/weapon/organ/r_arm
	name = "right arm"
	icon_state = "r_foreleg"
obj/item/weapon/organ/r_foot
	name = "right foot"
	icon_state = "r_backhoof"
obj/item/weapon/organ/r_hand
	name = "right hand"
	icon_state = "r_forehoof"
obj/item/weapon/organ/r_leg
	name = "right leg"
	icon_state = "r_backleg"
obj/item/weapon/organ/head
	name = "head"
	icon_state = "head_m"

obj/item/weapon/organ/head/New(loc, mob/living/carbon/pony/H)
	if(istype(H))
		src.icon_state = H.gender == MALE? "head_m" : "head_f"
	..()
	//Add (facial) hair.
	if(gender == FEMALE)	overlays.Add(new /icon('icons/mob/pony.dmi', "f1"))
	else					overlays.Add(new /icon('icons/mob/pony.dmi', "m"))
	if(H.f_style)
