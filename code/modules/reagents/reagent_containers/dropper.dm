...
/obj/item/weapon/reagent_containers/dropper
	...
	afterattack(obj/target, mob/user , flag)
		...
		if(filled)
			...
			if(!target.is_open_container() && !ismob(target) && !istype(target,/obj/item/weapon/reagent_containers/food) && !istype(target, /obj/item/clothing/mask/smokable/cigarette)) //You can inject ponys and food but you cant remove the shit.
			...
			if(ismob(target))
				...
				if(istype(target , /mob/living/carbon/pony))
					var/mob/living/carbon/pony/victim = target
