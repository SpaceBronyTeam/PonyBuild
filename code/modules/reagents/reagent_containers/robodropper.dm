...
/obj/item/weapon/reagent_containers/robodropper
	...
	afterattack(obj/target, mob/user , flag)
		...
		if(filled)
			...
			if(!target.is_open_container() && !ismob(target) && !istype(target,/obj/item/weapon/reagent_containers/food)) //You can inject ponys and food but you cant remove the shit.
