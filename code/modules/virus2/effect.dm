...
/datum/disease2/effectholder/proc/runeffect(var/mob/living/carbon/pony/mob,var/stage)
...
/datum/disease2/effect
	var/chance_maxm = 50 //note that disease effects only proc once every 3 ticks for ponys
...
/datum/disease2/effect/gibbingtons
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		...
		if(istype(mob, /mob/living/carbon/pony))
			var/mob/living/carbon/pony/H = mob
...
/datum/disease2/effect/organs
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		if(istype(mob, /mob/living/carbon/pony))
			var/mob/living/carbon/pony/H = mob
			var/organ = pick(list("r_foreleg","r_foreleg","r_backleg","r_backleg"))
...
/datum/disease2/effect/hair
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		if(istype(mob, /mob/living/carbon/pony))
			var/mob/living/carbon/pony/H = mob
			if(H.species.name == "Earthpony" && !(H.h_style == "Bald") && !(H.h_style == "Balding Hair"))
