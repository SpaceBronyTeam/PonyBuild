...
/obj/item/weapon/rig
	...
	var/mob/living/carbon/pony/wearer                        // The person currently wearing the rig.
...
/obj/item/weapon/rig/proc/toggle_seals(var/mob/living/carbon/pony/M,var/instant)
...
/obj/item/weapon/rig/proc/check_suit_access(var/mob/living/carbon/pony/user)
...
/obj/item/weapon/rig/Topic(href,href_list)
	...
	if(href_list["toggle_piece"])
		if(ispony(usr) && (usr.stat || usr.stunned || usr.lying))
			return 0
...
/obj/item/weapon/rig/equipped(mob/living/carbon/pony/M)
	..()
...
/obj/item/weapon/rig/proc/toggle_piece(var/piece, var/mob/living/carbon/pony/H, var/deploy_mode)
	...
	if(use_obj)
		if(check_slot == use_obj && deploy_mode != ONLY_DEPLOY)
			...
			var/mob/living/carbon/pony/holder
...
/obj/item/weapon/rig/proc/malfunction_check(var/mob/living/carbon/pony/user)
