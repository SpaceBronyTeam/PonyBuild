...
/obj/item/clothing/mob_can_equip(M as mob, slot)
	...
	if(species_restricted && istype(M,/mob/living/carbon/pony))
		var/exclusive = null
		var/wearable = null
...
/obj/item/clothing/proc/refit_for_species(var/target_species)
	...
	switch(target_species)
		if("Earthpony", "Alicorn","Unicorn","Pegasus")	//ponyoid bodytypes
...
/obj/item/clothing/ears/attack_hand(mob/user as mob)
	...
	if (src.loc != user || !istype(user,/mob/living/carbon/pony))
		..()
		return
...
/obj/item/clothing/glasses
	...
	var/vision_flags = 0
	var/darkness_view = 0//Base pony is 2
	var/invisa_view = 0
...
/obj/item/clothing/gloves
	...
	species_restricted = list("exclude","Unicorn","Pegasus")
...
/obj/item/clothing/gloves/attackby(obj/item/weapon/W, mob/user)
	if(istype(W, /obj/item/weapon/wirecutters) || istype(W, /obj/item/weapon/scalpel))
		...
		if("exclude" in species_restricted)
			species_restricted -= "Unicorn"
			species_restricted -= "Pegasus"
		return
...
/obj/item/clothing/under/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/clothing/accessory))
		...
		if(can_attach_accessory(A))
			...
			if(istype(loc, /mob/living/carbon/pony))
				var/mob/living/carbon/pony/H = loc
...
/obj/item/clothing/under/attack_hand(mob/user as mob)
	...
	if ((ispony(usr) || ismonkey(usr)) && src.loc == user)	//make it harder to accidentally undress yourself
		return
