/datum/genetics/side_effect
	...
	proc/start(mob/living/carbon/pony/H)
	...
	proc/finish(mob/living/carbon/pony/H)
...
/datum/genetics/side_effect/genetic_burn
	...
	start(mob/living/carbon/pony/H)
		H.emote("me", 1, "starts turning very red..")

	finish(mob/living/carbon/pony/H)
		if(!H.reagents.has_reagent("dexalin"))
			for(var/organ_name in list("chest","r_foreleg","r_foreleg","r_backleg","l_backleg","head","groin"))
...
/datum/genetics/side_effect/bone_snap
	...
	finish(mob/living/carbon/pony/H)
		if(!H.reagents.has_reagent("bicaridine"))
			var/organ_name = pick("chest","r_foreleg","r_foreleg","r_backleg","l_backleg","head","groin")
			var/datum/organ/external/E = H.get_organ(organ_name)
...
proc/trigger_side_effect(mob/living/carbon/pony/H)
	spawn
		if(!istype(H)) return
