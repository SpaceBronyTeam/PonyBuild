...
/obj/item/weapon/vampiric/process()
	...
	if(world.time - last_bloodcall > bloodcall_interval && nearby_mobs.len)
		var/mob/living/carbon/pony/M = pop(nearby_mobs)
...
/obj/item/weapon/vampiric/proc/bloodcall(var/mob/living/carbon/pony/M)
	last_bloodcall = world.time
	if(istype(M))
		playsound(src.loc, pick('sound/hallucinations/wail.ogg','sound/hallucinations/veryfar_noise.ogg','sound/hallucinations/far_noise.ogg'), 50, 1, -3)
		nearby_mobs.Add(M)

		var/target = pick("chest","groin","head","r_foreleg","r_foreleg","r_backleg","l_backleg","l_forehoof","r_forehoof","l_backhoof","r_backhoof")
