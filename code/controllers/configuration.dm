...
//	var/enable_authentication = 0		// goon authentication
	...
	var/uneducated_mice = 0 //Set to 1 to prevent newly-spawned mice from understanding pony speech

	var/usealienwhitelist = 0
	var/limitalienplayers = 0
	var/alien_to_pony_ratio = 0.5
	...
	var/list/admin_levels= list(3)					// Defines which Z-levels which are for admin functionality, for example including such areas as Central Command and the Syndicate Shuttle		 +	var/list/admin_levels= list(3)					// Defines which Z-levels which are for admin functionality, for example including such areas as Central Command and the Syndicate Shuttle
	var/list/contact_levels = list(1,2,4,5,6)			// Defines which Z-levels which, for example, a Code Red announcement may affect		 +	var/list/contact_levels = list(1,2,4,5,6)			// Defines which Z-levels which, for example, a Code Red announcement may affect
	var/list/player_levels = list(1,2, 4, 5, 6,7)	// Defines all Z-levels a character can typically reach		 +	var/list/player_levels = list(1,2, 4, 5, 6,7)	// Defines all Z-levels a character can typically reach
...
//					config.enable_authentication = 1
				...
				if("alien_player_ratio")
					limitalienplayers = 1
					alien_to_pony_ratio = text2num(value)
